...
function initializeAllSettings() {
    ...
    createSetting('beforegen', ['Gain Mi', 'Gain Fuel', 'Hybrid'], '<b>MODE BEFORE FUELING: </b>Which mode to use before fueling. This is the mode which the generator will use if you fuel after z230.<br>If you choose Hybrid before buying the upgrade, it will fuel until you are full tank, then get Mi for the rest of the run.', 'multitoggle', 1, null, 'Magma');
    ...
    createSetting('defaultgen', ['Gain Mi', 'Gain Fuel', 'Hybrid'], '<b>MODE AFTER FUELING: </b>Which mode to use after fueling.<br>If you choose Hybrid before buying the upgrade, it will just use Mi mode until the end of the run.', 'multitoggle', 1, null, 'Magma');
