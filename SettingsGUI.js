...
function initializeAllSettings() {
    ...
    createSetting('VoidHDMult', 'Void H:D Mult', "This is a multiplier to your <b>mapCutOff</b> and <b>farming H:D</b>, and only works at your void map zones. Values below 1 will make VMs require <b>more</b> damage. <br>Usually 1 is fine, but if you're doing VMs much later than you should, consider 2 or 4. Values below 1 may cause you to farm more than you should, because you'd be one-shooting everything anyway.", 'value', '1', null, 'Maps');
    createSetting('VoidHitsMult', 'Void Hits Mult', "This is a multiplier to your <b>numHitsSurvived</b>, and only works at your void map zones. Values below 1 will make VMs require <b>less</b> health. <br>Smaller values like 0.5 are better early game to reduce farming, while bigger values like 2 work well later, since you'll be doing many VMs, so you don't your trimps dying and slowing you down.", 'value', '2', null, 'Maps');
