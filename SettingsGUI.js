...
function initializeAllSettings() {
    ...
    createSetting('DynamicPrestigeChoose', 'Dynamic Prestige Goal', '', 'dropdown', 'Polierarm', ['Off', 'Supershield', 'Dagadder', 'Bootboost', 'Megamace', 'Hellishmet', 'Polierarm', 'Pantastic', 'Axeidic', 'Smoldershoulder', 'Greatersword', 'Bestplate', 'Harmbalest', 'GambesOP'], "Gear");
...
function updateCustomButtons() {
    ...
    //Gear
    var autoGearLimit = getPageSetting('autoGearLimit');
    ...
    !radonon ? turnOn("DynamicPrestigeChoose") : turnOff("DynamicPrestigeChoose");
    ...
    document.getElementById('DynamicPrestigeChoose').value = autoTrimpSettings.DynamicPrestigeChoose.selected;
    ...
    if (document.getElementById('DynamicPrestigeChoose').selectedIndex > 11 && game.global.slowDone == false) {
        document.getElementById('DynamicPrestigeChoose').selectedIndex = 11;
        autoTrimpSettings.DynamicPrestigeChoose.selected = "Bestplate";
    }
