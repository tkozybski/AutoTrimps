...
function initializeAllSettings() {
    ...
    createSetting('onlyminmaxworld', ['Min & Max: Apply Everywhere', 'Min & Max: World Only', 'Min: World Only & Max: Corrupted Only', 'Min: World Only & Max: Healthy Only'], 'Further restricts scrying usage based on the current world zone.<br><b>Everywhere:</b> Places configured as MAYBE are only scryable if within Min & Max Range.<br><b>World Only:</b> Only the World is affected by Min & Max zones.<br><b>Corrupted Only:</b> Only Corrupted and Healthy enemies in the World are affected by the Max zone setting.<br><b>Healthy Only:</b> Only Healthy enemies in the World are affected by the Max zone setting.', 'multitoggle', 2, null, 'Scryer');
