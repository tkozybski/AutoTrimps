...
function initializeAllSettings() {
    ...
    createSetting('SpireHD', 'Spire H:D Mult', "This value will replace your <b>mapCutOff</b> and <b>farming H:D</b> settings, but it only works at active Spires. Keep in mind that 4 actually 1 hit in D stance. <br>Try to find a value that will minimize farming, while still ensuring you won't run out of lives before hitting your target row.", 'value', '4', null, 'Maps');
    createSetting('SpireHitsSurvived', 'Spire Hits Mult', "This value will replace your <b>numHitsSurvived</b> setting, but it only works at active Spires. Keep in mind that 0.25 actually means you survive 1 hit in H stance. <br>Try to find a value that will minimize farming, while still ensuring you won't run out of lives before hitting your target row.", 'value', '5', null, 'Maps');
    ...
    createSetting('onlyminmaxworld', ['Min & Max: Everywhere', 'Min & Max: World', 'Min & Max: Corrupted', 'Min & Max: Healthy'], 'Further restricts scrying usage based on the current world zone.<br><br><b>Everywhere:</b> Places set as MAYBE are affected by Min & Max Range.<br><b>World:</b> Only the World is affected by Min & Max zones.<br><b>Corrupted:</b> Only Corrupted and Healthy enemies in the World are affected.<br><b>Healthy:</b> Only Healthy enemies in the World are affected.', 'multitoggle', 2, null, 'Scryer');
