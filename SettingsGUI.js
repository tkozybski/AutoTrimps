...
function initializeAllSettings() {
    ...
    createSetting('CustomTargetZone', 'Custom Target Zone', 'To be used with Auto Gigas. <br>The zone to be used as a the target zone when calculating the Auto Gigas delta. <br>Values below 60 will use your HZE as a target zone.', 'value', '-1', null, "Buildings");
